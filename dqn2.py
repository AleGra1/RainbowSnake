...
from noisy_net import NoisyNetwork
...
class Agent():
    def __init__(self, gamma, epsilon, lr, n_actions, input_dims, mem_size, batch_size, eps_min=0.1, eps_dec=5e-7, tau=1000, checkpoint_dir='checkpoints'):
        ...
        self.dqn = NoisyNetwork(self.n_actions, "noisy", self.input_dims, self.checkpoint_dir)
        self.dqn_target = NoisyNetwork(self.n_actions, "noisy", self.input_dims, self.checkpoint_dir)

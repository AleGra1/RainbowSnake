...
class Agent():
    def __init__(self, gamma, epsilon, lr, n_actions, input_dims, mem_size, batch_size, eps_min=0.1, eps_dec=5e-7, tau=1000, checkpoint_dir='checkpoints', alpha=0.2, beta=0.6, eps_prior=1e-6, n_step=3):
        self.gamma = gamma
        ...
        self.memory = ReplayBuffer(self.mem_size, self.input_dims, 1, self.gamma)
    ...
    def learn(self):
        ...
        state, action, reward, state_, done, indices = self.memory.sample(self.batch_size)
